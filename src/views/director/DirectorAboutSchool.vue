<template>
    <div class="about-container">
        ...
        <div class="school-info">
            ...
            <div>
                <v-text-field v-model="schoolObj.name" :rules="required" label="Полное название" readonly/>
            </div>

            <div>
                <v-text-field v-model="schoolObj.pin" :rules="required" label="Пин школы" type="number" readonly/>
            </div>
            ...
            <div class="spacer">
                <v-text-field v-model="schoolObj.phone" label="Номер телефона" type="number" readonly/>
            </div>

            <div>
                <v-text-field label="Email" v-model="schoolObj.email" :rules="emailRules" readonly/>
            </div>
